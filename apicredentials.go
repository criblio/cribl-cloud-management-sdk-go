...
import (
	...
	"github.com/Cribl-Community/cribl-cloud-management-sdk-go/internal/hooks"
	...
	"github.com/Cribl-Community/cribl-cloud-management-sdk-go/models/operations"
...
func (s *APICredentials) Create(ctx context.Context, organizationID string, apiCredentialCreateRequestDTO components.APICredentialCreateRequestDTO, opts ...operations.Option) (*operations.V1APICredentialsCreateAPICredentialResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.APICredentialCreateResponseSchema
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.APICredentialCreateResponseSchema = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
	...
	case httpRes.StatusCode == 422:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.DefaultErrorDTO
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
